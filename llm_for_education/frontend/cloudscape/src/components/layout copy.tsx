...
import { Alert, Button, Container, Header, SpaceBetween, SideNavigation, TopNavigation, TopNavigationProps, AppLayout } from "@cloudscape-design/components";
   ...
   const navItems = [
       {
           ...
           items: 
               [
               { type: 'link', text: 'Page 1', href: '#/page1', onclick: () => navigate("/page1") },
               { type: 'link', text: 'Page 2', href: '#/page2', onclick: () => navigate("/page2") },
               { type: 'link', text: 'Page 3', href: '#/page3', onclick: () => navigate("/page3") },
      ],
    },
  ];
    ...
    let navigation = <SideNavigation items={[
       {
           type: 'section',
           text: 'Manage',
           href: "#",
